...
Das Einbinden von Quelltexten ist in \LaTeX mit dem Listings-Paket sehr komfortabel möglich. Es lassen sich verschiedene Sprachen definieren und man kann aktiv in die Darstellung der einzelnen Sprachelemente eingreifen.

%************** XML ******************
\subsection{XML}
Beispiel für XML-Code siehe Quelltext \ref{lst_xml_code}
...
%************** JAVA ******************
\subsection{JAVA}
Beispiel für Java-Code siehe Quelltext \ref{lst_java_code}
...
%************** BILDER ******************
\subsection{Bilder}
Beispiel um ein Bild einzufügen siehe Abbildung \ref{fig:FB4Bild}

\begin{figure}[!h]
	\includegraphics[width=4.4in]{content/images/52_Foto_FHDortmund_Gebaeude.jpg}
	\caption{Gebäude des FB4}
	\label{fig:FB4Bild}
\end{figure}
