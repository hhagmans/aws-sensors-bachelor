...
\contentsline {lstlisting}{\numberline {3.3}TemperatureProducer.java (ll. 229-250): Initialisierung eines \texttt {Callbacks} um R\"uckmeldungen der Threads zu bekommen}{13}{lstlisting.3.3}
...
\contentsline {lstlisting}{\numberline {3.12}TemperatureConsumer.java (ll. 121-123): Initialisierung von Variablen in der \texttt {processRecords} Methode}{19}{lstlisting.3.12}
...
\contentsline {lstlisting}{\numberline {3.15}DynamoDBUtils.java (ll. 158-184): Persistierung der Daten auf DynamoDB}{21}{lstlisting.3.15}
...
\contentsline {lstlisting}{\numberline {3.17}ServletStarter.java (ll. 41-46): Servlet wird in \texttt {Context} gesetzt}{23}{lstlisting.3.17}
\contentsline {lstlisting}{\numberline {3.18}ServletStarter.java (ll. 48-54): \texttt {Context} wird den Handlern zugef\"ugt}{23}{lstlisting.3.18}
...
\contentsline {lstlisting}{\numberline {3.20}DynamoDBUtils.java (ll. 228-242): Die Methode \texttt {getAllSensorTemperatures}}{24}{lstlisting.3.20}
\contentsline {lstlisting}{\numberline {3.21}DynamoDBUtils.java (ll. 198-217): Die Methode \texttt {getTemperaturesForSensor}}{25}{lstlisting.3.21}
\contentsline {lstlisting}{\numberline {3.22}TemperatureServlet.java (ll. 75-89): Iteration \"uber die HashMaps}{26}{lstlisting.3.22}
\contentsline {lstlisting}{\numberline {3.23}DeleteResources.java (ll. 24-30): Auslesen der \"ubergebenen Argumente in \texttt {DeleteResources}}{27}{lstlisting.3.23}
\contentsline {lstlisting}{\numberline {3.24}DeleteResources.java (ll. 32-43): Initialisierung der \texttt {DynamoDBUtils}-Klasse und L\"oschen der Tabellen}{27}{lstlisting.3.24}
...
\contentsline {lstlisting}{\numberline {3.27}Konsolenbefehl zum Starten des Docker Images}{29}{lstlisting.3.27}
\addvspace {10\p@ }
\contentsline {lstlisting}{\numberline {4.1}Einf\"ugen eines Ger\"ats in die Registry. Quelle: \cite {iot_registry}}{37}{lstlisting.4.1}
\contentsline {lstlisting}{\numberline {4.2}Ger\"ateeintrag in der Registry. Quelle: \cite {iot_registry}}{38}{lstlisting.4.2}
\contentsline {lstlisting}{\numberline {4.3}Erstellen einer AWS IoT Regel. Quelle: \cite {iot_rules}}{38}{lstlisting.4.3}
\contentsline {lstlisting}{\numberline {4.4}Inhalt einer Payload Datei. Quelle: \cite {iot_rules}}{38}{lstlisting.4.4}
\contentsline {lstlisting}{\numberline {4.5}GET Anfrage an einen ``Ger\"ateschatten''. Quelle: \cite {iot_get_thingshadow}}{39}{lstlisting.4.5}
\contentsline {lstlisting}{\numberline {4.6}GET Antwort auf die Anfrage an einen ``Ger\"ateschatten''. Quelle: \cite {iot_get_thingshadow}}{39}{lstlisting.4.6}
\addvspace {10\p@ }
\addvspace {10\p@ }
